...
public final class ACountPrefixUnaryPrefixOp extends PUnaryPrefixOp
{
    private TSopCount _sopCount_;

    public ACountPrefixUnaryPrefixOp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACountPrefixUnaryPrefixOp(
    ...
    {
        ((Analysis) sw).caseACountPrefixUnaryPrefixOp(this);
    }
