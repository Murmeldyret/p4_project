...
public final class AAssignmentStatementStmt extends PStmt
{
    private PAssignment _assignment_;

    public AAssignmentStatementStmt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAssignmentStatementStmt(
    ...
    {
        ((Analysis) sw).caseAAssignmentStatementStmt(this);
    }
