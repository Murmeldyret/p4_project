...
public final class AGroupbyPrefixUnaryPrefixOp extends PUnaryPrefixOp
{
    private TSopGroupby _sopGroupby_;

    public AGroupbyPrefixUnaryPrefixOp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGroupbyPrefixUnaryPrefixOp(
    ...
    {
        ((Analysis) sw).caseAGroupbyPrefixUnaryPrefixOp(this);
    }
