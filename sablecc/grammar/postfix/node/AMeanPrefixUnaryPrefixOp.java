...
public final class AMeanPrefixUnaryPrefixOp extends PUnaryPrefixOp
{
    private TSopMean _sopMean_;

    public AMeanPrefixUnaryPrefixOp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMeanPrefixUnaryPrefixOp(
    ...
    {
        ((Analysis) sw).caseAMeanPrefixUnaryPrefixOp(this);
    }
