...
public final class AGroupbyOpSpecialOp extends PSpecialOp
{
    private TSopGroupby _sopGroupby_;

    public AGroupbyOpSpecialOp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGroupbyOpSpecialOp(
    ...
    {
        ((Analysis) sw).caseAGroupbyOpSpecialOp(this);
    }
