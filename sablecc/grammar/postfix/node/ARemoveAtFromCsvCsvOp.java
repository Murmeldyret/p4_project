...
public final class ARemoveAtFromCsvCsvOp extends PCsvOp
{
    ...
    public Object clone()
    {
        return new ARemoveAtFromCsvCsvOp(
    ...
    {
        ((Analysis) sw).caseARemoveAtFromCsvCsvOp(this);
    }
