...
public final class ASortDescSpecialSyntax extends PSpecialSyntax
{
    ...
    public Object clone()
    {
        return new ASortDescSpecialSyntax(
    ...
    {
        ((Analysis) sw).caseASortDescSpecialSyntax(this);
    }
